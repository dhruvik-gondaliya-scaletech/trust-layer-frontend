        ...
        <Card className="border border-border bg-white shadow-sm overflow-hidden">
          <div className="flex flex-col divide-y divide-gray-100">
            ...
            <div onClick={() => navigate("/timeline/deal-123")} className="cursor-pointer hover:bg-gray-50 transition-colors p-3.5 flex items-center justify-between group">
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <span className="text-[12px] font-semibold text-emerald-600 leading-none">Funds Released</span>
                </div>
              </div>
            ...
            <div className="cursor-pointer hover:bg-gray-50 transition-colors p-3.5 flex items-center justify-between group">
              <div className="flex items-center gap-3.5">
                <div className="w-12 h-12 bg-gray-100 rounded-xl overflow-hidden shrink-0 border border-gray-200">
                  <img src="https://images.unsplash.com/photo-1523170335258-f5ed11844a49?q=80&w=200&auto=format&fit=crop" alt="Rolex" className="w-full h-full object-cover" />
                </div>
                <div className="flex flex-col justify-center">
                  <span className="font-bold text-[15px] text-foreground leading-tight mb-0.5">Vintage Rolex</span>
                  <div className="flex items-center gap-1.5 mb-0.5">
                    <span className="text-[10px] font-bold text-[#2563EB] uppercase tracking-wider">Selling</span>
                    <span className="text-gray-300">•</span>
                    <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Deal ID: TRUST-1024</span>
                  ...
                  <span className="text-[12px] font-semibold text-amber-600 leading-none">Awaiting Buyer Approval</span>
                </div>
              </div>
              <div className="flex flex-col items-end justify-center">
                <span className="font-extrabold text-[15px] text-foreground mb-1">$8,500</span>
                <ChevronRight className="w-4 h-4 text-gray-300 group-hover:text-gray-500 transition-colors" />
              </div>
            </div>
            ...
            <div className="cursor-pointer hover:bg-gray-50 transition-colors p-3.5 flex items-center justify-between group">
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <span className="text-[12px] font-semibold text-gray-500 leading-none">Completed</span>
                </div>
              </div>
              <div className="flex flex-col items-end justify-center">

        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3.5">
            <motion.div 
              ...
              className="h-[60px] w-[60px] bg-secondary rounded-full flex items-center justify-center text-primary font-bold overflow-hidden border-2 border-white shadow-md shrink-0"
            >
          ...
          >
            <div className="h-11 w-11 bg-white rounded-full flex items-center justify-center border border-gray-200 shadow-sm text-foreground">
      ...
      <div className="space-y-3">
        ...
        <Card className="border border-border bg-white shadow-sm overflow-hidden">
          <div className="p-3.5 flex items-center justify-between">
            ...
            <Button size="sm" className="bg-amber-500 hover:bg-amber-600 text-white font-bold h-8 px-3" onClick={() => navigate("/timeline/deal-123")}>
              Action
            </Button>
          </div>
        </Card>
      ...
      <div className="space-y-2">
        ...
        <Card className="border border-border bg-white shadow-sm overflow-hidden">
          <div className="flex flex-col divide-y divide-gray-100">
            ...
            <div onClick={() => navigate("/timeline/deal-123")} className="cursor-pointer hover:bg-gray-50 transition-colors p-3.5 flex items-center justify-between group">
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex flex-col justify-center">
                  <span className="font-bold text-[15px] text-foreground leading-tight mb-0.5">Charizard Holo 1999 Base Set</span>
                  <div className="flex items-center gap-1.5 mb-0.5">
                    <span className="text-[10px] font-bold text-[#2563EB] uppercase tracking-wider">Selling</span>
            ...
            {/* Item 2 */}
            <div onClick={() => navigate("/timeline/deal-124")} className="cursor-pointer hover:bg-gray-50 transition-colors p-3.5 flex items-center justify-between group">
              <div className="flex items-center gap-3.5">
                <div className="w-12 h-12 bg-gray-100 rounded-xl overflow-hidden shrink-0 border border-gray-200">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <span className="text-[12px] font-semibold text-[#10B981] leading-none">In Transit</span>
                </div>
              </div>
              <div className="flex flex-col items-end justify-center">
            ...
            <div className="cursor-pointer hover:bg-gray-50 transition-colors p-3.5 flex items-center justify-between group">
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <span className="text-[12px] font-semibold text-gray-500 leading-none">Delivered</span>
                </div>
              </div>
              <div className="flex flex-col items-end justify-center">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between mb-4 bg-black/10 rounded-xl p-3 backdrop-blur-sm border border-white/5">
              <div className="flex-1">
                <p className="text-[10px] text-blue-100/70 font-bold tracking-wider uppercase mb-0.5">In Escrow</p>
